...
class Link(models.Model):
    ...
    title: str = models.CharField(_("title"), max_length=100, help_text="Required.")
    ...
    type_of_link: str = models.CharField(_("type"), max_length=10, default=TypeOfLink.WEBSITE, help_text="Required.", 
